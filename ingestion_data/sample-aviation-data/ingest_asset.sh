...
do
  ...
  echo $f 
  curl -X POST -H "Authorization: bearer $token" -H "tenant: $tenant" -H "Content-Type: multipart/form-data" -F "file=@$f" "https://apm-s95-adapter-hackapm.run.aws-usw02-pr.ice.predix.io/v1/asset/upload"
